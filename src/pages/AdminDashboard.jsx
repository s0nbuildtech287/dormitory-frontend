          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="px-6 py-4 font-medium text-slate-900">Phê duyệt hồ sơ SV2024001</td>
                <td className="px-6 py-4 text-slate-600">Admin</td>
                <td className="px-6 py-4 text-slate-500 text-sm">10 phút trước</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-xs font-bold uppercase">Thành công</span>
                </td>
              </tr>
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="px-6 py-4 font-medium text-slate-900">Tạo hóa đơn điện nước tầng 3</td>
                <td className="px-6 py-4 text-slate-600">Admin</td>
                <td className="px-6 py-4 text-slate-500 text-sm">1 giờ trước</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-xs font-bold uppercase">Thành công</span>
                </td>
              </tr>
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="px-6 py-4 font-medium text-slate-900">Cập nhật nội quy phòng cháy</td>
                <td className="px-6 py-4 text-slate-600">Admin</td>
                <td className="px-6 py-4 text-slate-500 text-sm">3 giờ trước</td>
                <td className="px-6 py-4">
