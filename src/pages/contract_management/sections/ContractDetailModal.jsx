...
import { X, Mail, Phone, FileText, User, Home, Building2, CheckCircle2, Clock, XCircle, AlertTriangle, RefreshCw, Sparkles, Star, FileX } from "lucide-react";
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-50 p-4 rounded-xl">
                  <p className="text-slate-600 text-xs font-semibold mb-1">Trạng thái cọc</p>
                  <p className={`font-bold ${contract.deposit_paid ? "text-emerald-700" : "text-amber-700"}`}>{contract.deposit_paid ? "Đã nộp" : "Chưa nộp"}</p>
                </div>
